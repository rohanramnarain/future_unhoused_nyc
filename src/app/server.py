...
LIGHTGBM_COPY = html.Div(className="card", children=[
    ...
    html.P("Because LightGBM only needs the engineered service counts plus DCP housing stats (`n311_y`, `nhpd_y`, `nevict_y`, `nfiled_y`, `n_dcp_units`, `n_dcp_aff_units`, `n_dcp_expiring5yr`, `n_dcp_expired`, `dcp_status_median`), it stays fast enough for this project while still capturing non-linear jumps—like a sudden spike in HPD complaints—without overwhelming non-technical collaborators."),
